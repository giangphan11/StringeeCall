package vn.com.phanbagiang.myapplication.base;
...
/**
 * Created by giangphanba on 10/28/2021.
 */
public class GiangChart extends HorizontalBarChart {

    public GiangChart(Context context) {
        super(context);
    }

    public GiangChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        readRadiusAttr(context, attrs);
    }

    public GiangChart(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        readRadiusAttr(context, attrs);
    }

    private void readRadiusAttr(Context context, AttributeSet attrs) {
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.GiangChart, 0, 0);
        try {
            setRadius(a.getDimensionPixelSize(R.styleable.GiangChart_radius, 0));
        } finally {
            a.recycle();
        }
    }
